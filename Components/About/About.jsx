    ...
    <div className="bg-black text-white py-10 px-4 md:px-10 lg:px-20">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center">
        <div className="lg:w-2/3">
          ...
          <p className="text-xl italic text-white mb-8 font-stalemate lg:text-[65px]">Elevating <span className="font-normal text-red-500">beauty</span>, one visit at a time.</p>
